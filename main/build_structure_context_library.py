...
aa_properties = {
    'A': {'hydrophobic': True, 'polar': False, 'charged': False, 'charge': 0, 'size': 'small', 'vdw_volume': 67, 'neg_charge': 0, 'pos_charge': 0, 'aromatic': False, 'aliphatic': True, 'sulfur': False, 'hydroxyl': False},
    'R': {'hydrophobic': False, 'polar': True, 'charged': True, 'charge': 1, 'size': 'large', 'vdw_volume': 148, 'neg_charge': 0, 'pos_charge': 1, 'aromatic': False, 'aliphatic': False, 'sulfur': False, 'hydroxyl': False},
    'N': {'hydrophobic': False, 'polar': True, 'charged': False, 'charge': 0, 'size': 'medium', 'vdw_volume': 96, 'neg_charge': 0, 'pos_charge': 0, 'aromatic': False, 'aliphatic': False, 'sulfur': False, 'hydroxyl': False},
    'D': {'hydrophobic': False, 'polar': True, 'charged': True, 'charge': -1, 'size': 'medium', 'vdw_volume': 91, 'neg_charge': 1, 'pos_charge': 0, 'aromatic': False, 'aliphatic': False, 'sulfur': False, 'hydroxyl': False},
    'C': {'hydrophobic': True, 'polar': False, 'charged': False, 'charge': 0, 'size': 'medium', 'vdw_volume': 86, 'neg_charge': 0, 'pos_charge': 0, 'aromatic': False, 'aliphatic': False, 'sulfur': True, 'hydroxyl': False},
    'Q': {'hydrophobic': False, 'polar': True, 'charged': False, 'charge': 0, 'size': 'medium', 'vdw_volume': 114, 'neg_charge': 0, 'pos_charge': 0, 'aromatic': False, 'aliphatic': False, 'sulfur': False, 'hydroxyl': False},
    'E': {'hydrophobic': False, 'polar': True, 'charged': True, 'charge': -1, 'size': 'medium', 'vdw_volume': 109, 'neg_charge': 1, 'pos_charge': 0, 'aromatic': False, 'aliphatic': False, 'sulfur': False, 'hydroxyl': False},
    'G': {'hydrophobic': True, 'polar': False, 'charged': False, 'charge': 0, 'size': 'small', 'vdw_volume': 48, 'neg_charge': 0, 'pos_charge': 0, 'aromatic': False, 'aliphatic': False, 'sulfur': False, 'hydroxyl': False},
    'H': {'hydrophobic': False, 'polar': True, 'charged': True, 'charge': 0.5, 'size': 'medium', 'vdw_volume': 118, 'neg_charge': 0, 'pos_charge': 0.5, 'aromatic': True, 'aliphatic': False, 'sulfur': False, 'hydroxyl': False},
    'I': {'hydrophobic': True, 'polar': False, 'charged': False, 'charge': 0, 'size': 'large', 'vdw_volume': 124, 'neg_charge': 0, 'pos_charge': 0, 'aromatic': False, 'aliphatic': True, 'sulfur': False, 'hydroxyl': False},
    'L': {'hydrophobic': True, 'polar': False, 'charged': False, 'charge': 0, 'size': 'large', 'vdw_volume': 124, 'neg_charge': 0, 'pos_charge': 0, 'aromatic': False, 'aliphatic': True, 'sulfur': False, 'hydroxyl': False},
    'K': {'hydrophobic': False, 'polar': True, 'charged': True, 'charge': 1, 'size': 'large', 'vdw_volume': 135, 'neg_charge': 0, 'pos_charge': 1, 'aromatic': False, 'aliphatic': False, 'sulfur': False, 'hydroxyl': False},
    'M': {'hydrophobic': True, 'polar': False, 'charged': False, 'charge': 0, 'size': 'large', 'vdw_volume': 124, 'neg_charge': 0, 'pos_charge': 0, 'aromatic': False, 'aliphatic': False, 'sulfur': True, 'hydroxyl': False},
    'F': {'hydrophobic': True, 'polar': False, 'charged': False, 'charge': 0, 'size': 'large', 'vdw_volume': 135, 'neg_charge': 0, 'pos_charge': 0, 'aromatic': True, 'aliphatic': False, 'sulfur': False, 'hydroxyl': False},
    'P': {'hydrophobic': True, 'polar': False, 'charged': False, 'charge': 0, 'size': 'medium', 'vdw_volume': 90, 'neg_charge': 0, 'pos_charge': 0, 'aromatic': False, 'aliphatic': False, 'sulfur': False, 'hydroxyl': False},
    'S': {'hydrophobic': False, 'polar': True, 'charged': False, 'charge': 0, 'size': 'small', 'vdw_volume': 73, 'neg_charge': 0, 'pos_charge': 0, 'aromatic': False, 'aliphatic': False, 'sulfur': False, 'hydroxyl': True},
    'T': {'hydrophobic': False, 'polar': True, 'charged': False, 'charge': 0, 'size': 'medium', 'vdw_volume': 93, 'neg_charge': 0, 'pos_charge': 0, 'aromatic': False, 'aliphatic': False, 'sulfur': False, 'hydroxyl': True},
    'W': {'hydrophobic': True, 'polar': True, 'charged': False, 'charge': 0, 'size': 'large', 'vdw_volume': 163, 'neg_charge': 0, 'pos_charge': 0, 'aromatic': True, 'aliphatic': False, 'sulfur': False, 'hydroxyl': False},
    'Y': {'hydrophobic': False, 'polar': True, 'charged': False, 'charge': 0, 'size': 'large', 'vdw_volume': 141, 'neg_charge': 0, 'pos_charge': 0, 'aromatic': True, 'aliphatic': False, 'sulfur': False, 'hydroxyl': True},
    'V': {'hydrophobic': True, 'polar': False, 'charged': False, 'charge': 0, 'size': 'medium', 'vdw_volume': 105, 'neg_charge': 0, 'pos_charge': 0, 'aromatic': False, 'aliphatic': True, 'sulfur': False, 'hydroxyl': False},
}
...
def calculate_aromatic_features(residue, neighbors, radius=8.0):
    ...
    for neighbor in neighbors:
        ...
        if dist <= radius:
            ...
            if one_letter in aa_properties and aa_properties[one_letter]['charged'] and aa_properties[one_letter]['charge'] > 0:
    ...
    try:
        ...
        for chain_idx, chain in enumerate(model):
            ...
            for i, residue in enumerate(sty_residues):
                ...
                function_timings['find_neighbors'] = function_timings.get('find_neighbors', 0) + (time.time() - func_start)
                ...
                function_timings['get_sequence_motif'] = function_timings.get('get_sequence_motif', 0) + (time.time() - func_start)
                
                # Calculate motif pLDDT
                func_start = time.time()
                motif_plddt = calculate_motif_plddt(chain_data, residue, plddt_dict)
                function_timings['calculate_motif_plddt'] = function_timings.get('calculate_motif_plddt', 0) + (time.time() - func_start)
                ...
                function_timings['calculate_hydroxyl_exposure'] = function_timings.get('calculate_hydroxyl_exposure', 0) + (time.time() - func_start)
                
                # Calculate SASA
                func_start = time.time()
                total_sasa, hydroxyl_sasa = calculate_sasa_vectorized(residue, neighbors)
                function_timings['calculate_sasa'] = function_timings.get('calculate_sasa', 0) + (time.time() - func_start)
                
                # Calculate residue depth
                func_start = time.time()
                depth_results, min_depth, avg_depth, ca_depth, hydroxyl_depth = calculate_residue_depth_multi(residue, model)
                function_timings['calculate_residue_depth'] = function_timings.get('calculate_residue_depth', 0) + (time.time() - func_start)
                ...
                function_timings['analyze_pocket_properties'] = function_timings.get('analyze_pocket_properties', 0) + (time.time() - func_start)
                
                # Analyze pocket shape
                func_start = time.time()
                pocket_shape = analyze_pocket_shape(residue, neighbors)
                function_timings['analyze_pocket_shape'] = function_timings.get('analyze_pocket_shape', 0) + (time.time() - func_start)
                
                # Calculate cavity volume
                func_start = time.time()
                cavity_features = calculate_cavity_features(hydroxyl_atom, neighbors)
                function_timings['calculate_cavity_features'] = function_timings.get('calculate_cavity_features', 0) + (time.time() - func_start)

                
                # Calculate pocket solvent features
                func_start = time.time()
                solvent_features = calculate_pocket_solvent_features(residue, neighbors)
                function_timings['calculate_pocket_solvent'] = function_timings.get('calculate_pocket_solvent', 0) + (time.time() - func_start)
                ...
                function_timings['find_hydrogen_bonds'] = function_timings.get('find_hydrogen_bonds', 0) + (time.time() - func_start)
                
                # Calculate hydrogen bond energy
                func_start = time.time()
                hbond_energy_data = calculate_hydrogen_bond_energy(residue, neighbors)
                function_timings['calculate_hydrogen_bond_energy'] = function_timings.get('calculate_hydrogen_bond_energy', 0) + (time.time() - func_start)
                ...
                function_timings['calculate_ss_distances'] = function_timings.get('calculate_ss_distances', 0) + (time.time() - func_start)
                ...
                function_timings['calculate_side_chain_angles'] = function_timings.get('calculate_side_chain_angles', 0) + (time.time() - func_start)
                ...
                function_timings['calculate_packing_density'] = function_timings.get('calculate_packing_density', 0) + (time.time() - func_start)
                ...
                function_timings['calculate_contact_order'] = function_timings.get('calculate_contact_order', 0) + (time.time() - func_start)
                ...
                function_timings['calculate_nearest_distances'] = function_timings.get('calculate_nearest_distances', 0) + (time.time() - func_start)
                
                # Count nearby residues by type
                func_start = time.time()
                aa_counts, property_counts = num_nearest_type_vectorized(residue, neighbors)
                function_timings['count_nearest_residues'] = function_timings.get('count_nearest_residues', 0) + (time.time() - func_start)
                ...
                function_timings['calculate_bfactor_stats'] = function_timings.get('calculate_bfactor_stats', 0) + (time.time() - func_start)
                
                # Calculate local structural features
                func_start = time.time()
                local_structure = calculate_local_structural_features(residue, chain_data)
                function_timings['calculate_local_structure'] = function_timings.get('calculate_local_structure', 0) + (time.time() - func_start)
                
                # Calculate domain boundary features
                func_start = time.time()
                domain_features = calculate_domain_boundary_features(residue, chain_data)
                function_timings['calculate_domain_boundary'] = function_timings.get('calculate_domain_boundary', 0) + (time.time() - func_start)
                ...
                function_timings['calculate_disorder_features'] = function_timings.get('calculate_disorder_features', 0) + (time.time() - func_start)

                # Calculate pLDDT gradient features
                func_start = time.time()
                plddt_gradient_features = calculate_plddt_gradient_features(residue, chain_data, plddt_dict)
                function_timings['calculate_plddt_gradient'] = function_timings.get('calculate_plddt_gradient', 0) + (time.time() - func_start)
                ...
                function_timings['calculate_core_rim_surface'] = function_timings.get('calculate_core_rim_surface', 0) + (time.time() - func_start)
                ...
                function_timings['calculate_hydrophobic'] = function_timings.get('calculate_hydrophobic', 0) + (time.time() - func_start)
                
                # Calculate electrostatic features
                func_start = time.time()
                electrostatic_features = calculate_electrostatic_features(residue, neighbors)
                function_timings['calculate_electrostatic'] = function_timings.get('calculate_electrostatic', 0) + (time.time() - func_start)
                
                # Calculate aromatic features
                func_start = time.time()
                aromatic_features = calculate_aromatic_features(residue, neighbors)
                function_timings['calculate_aromatic'] = function_timings.get('calculate_aromatic', 0) + (time.time() - func_start)
...
def main():
    parser = argparse.ArgumentParser(description='Analyze STY residues in protein structure files with enhanced features')
